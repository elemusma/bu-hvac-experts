...
function create_block_content_testimonials_block_init() {
	...
	$script_url = plugins_url('owl-carousel/owl-carousels.js', __FILE__);
	...
	if ( ! wp_script_is( 'owl-carousel-testimonial', 'enqueued' ) ) {
		// wp_enqueue_script('owl-carousel-testimonial', __DIR__('/owl-carousel/owl-carousels.js'));
		wp_enqueue_script('owl-carousel-testimonial', $script_url, array('jquery'), null, true);
	}
