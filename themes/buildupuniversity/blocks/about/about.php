...
// start of side links
echo '<div class="col-md-5 col-side-links pr-md-5">';
...
echo '<div class="position-absolute w-100 h-100 about-side-links-bg"  style="top:0;left:0;background:black;"></div>';
...
echo '<div class="col-2">';
    echo '<div class="m-auto" style="height:100%;width:4px;background:black;"></div>';
echo '</div>';
...
// <!-- start of content -->
echo '<div class="col-md-5 pl-md-5" data-aos="fade-up" data-aos-delay="100">';
